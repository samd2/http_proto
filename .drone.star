...
def main(ctx):
  ...
  linux_cxx("CMAKE_INSTALL_TEST=1", "g++", packages="", buildscript="drone", buildtype="cmake1", image="cppalliance/droneubuntu1804:1", environment={'CMAKE_INSTALL_TEST': '1'}, globalenv=globalenv),
