...
def main(ctx):
  ...
  linux_cxx("cmake", "g++", packages="", buildscript="drone", buildtype="cmake1", image="cppalliance/droneubuntu2004:1", environment={'CMAKE_INSTALL_TEST': '1'}, globalenv=globalenv),
  linux_cxx("cmake-superproject", "g++", packages="", buildscript="drone", buildtype="cmake-superproject", image="cppalliance/droneubuntu2004:1", environment={'CMAKE_INSTALL_TEST': '1'}, globalenv=globalenv),
